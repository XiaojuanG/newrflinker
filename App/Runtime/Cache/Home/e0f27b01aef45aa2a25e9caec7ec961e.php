			        ...
			        <div class="col-sx-12 classification container">
						 ...
						 <?php if(is_array($hztype_arr)): $i = 0; $__LIST__ = $hztype_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-xs-12">
									...
									<ul class="list-unstyled ">
										<?php if(is_array($vo['type'])): $i = 0; $__LIST__ = $vo['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voer): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Rflinkerhztype/index');?>?typeid=<?php echo ($voer['id']); ?>&fid=<?php echo ($voer['hzid']); ?>" id="<?php echo ($voer['id']); ?>"><?php echo ($voer['rflinkertypename']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
							...
							<div class="panel-heading">
								<h4 class="panel-title text-center">
									<a data-toggle="collapse" data-parent="#accordion" 
									   href="#<?php echo (str_replace(' ','',$vo['type']['rflinkertypename'])); ?>">
										 <?php echo ($vo['type']['rflinkertypename']); ?> 
									</a>
								</h4>
							</div>
							<div id="<?php echo (str_replace(' ','',$vo['type']['rflinkertypename'])); ?>" class="panel-collapse collapse <?php if($j == 1): ?>in<?php else: endif; ?>">
													...
													<?php if(is_array($vo['pt'])): $i = 0; $__LIST__ = $vo['pt'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
															...
															<a href="projectDeta.html">
																<div class="product-text">
																	<a target="_top" href="<?php echo U('Productdetails/index');?>?type=2&&id=<?php echo ($pt['id']); ?>"><span><?php echo ($pt['rrname']); ?><i class="icon iconfont icon-fanhuiyou""></i></span></a>
																	<div><?php echo ($pt['rrtitle']); ?></div>
																</div> 
															</a>   
														</div><?php endforeach; endif; else: echo "" ;endif; ?>
