...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/new/Public/qiantai/css/aboutme.css">
  <!-- 联系我们 -->
  <link rel="stylesheet" type="text/css" href="/new/Public/qiantai/css/contact_us.css">
  <!--[if lt IE 9]>
  <script type="text/javascript" src="/new/Public/qiantai/js/html5shiv.min.js"></script>
  <script type="text/javascript" src="/new/Public/qiantai/js/respond.min.js"></script>
  <![endif]-->
    ...
    <div class="news">
      <div class="container">
        ...
        <div class="row news-content" >
          ...
          <div class="company">
            <img src="/new/Public/qiantai/img/about.png" style="width:100%;">
            <div class="company-abuot">
              <div class="common-title">
                <h3>公司名称公司名称公司名称</h3>

              </div>
              <p class="company-p" >体现了企业家的立场和信仰，是企业最高管理者头脑中的一种概念，是这些最高管理者对企业未来的设想。体现了企业家的立场和信仰，是企业最高管理者头脑中的一种概念</p>
              <p class="company-p">是对“我们代表什么”体现了企业家的立场和信仰。</p>
