...
<html>
	...
	<head>
		...
		<!-- 产品详情 -->
		<link rel="stylesheet" type="text/css" href="/new/Public/qiantai/css/productDeta.css">
		<!--[if lt IE 9]>
		...
		<link rel="stylesheet" type="text/css" href="/new/Public/qiantai/css/Case.css">
		<link rel="stylesheet" type="text/css" href="/new/Public/qiantai/css/iconfont.css">
			<style type="text/css">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">
          <img src="/new/Public/qiantai/img/login.png">
        </a>
      </div>
	     <script>
      ...
      <div class="collapse navbar-collapse" >
        ...
        <ul class="nav navbar-nav navbar-left top-nav">
          <li  id="nav_toggle"  style="line-height: 60px;width: 140px;text-align: center;margin-right: 10px">
            <a href="<?php echo U('?lang=ch-cn');?>" class=" nav_toggle <?php echo (L("languagesclicks")); ?>" style="display: inline;float: left;">中文</a>|
            <a href="<?php echo U('?lang=en-us');?>" class="nav_toggle <?php echo (L("languagesclick")); ?>" style="display: inline;float: right;">EN</a>
          </li>



          <li <?php if($style_change == Index): ?>class="active"<?php endif; ?>>
            <a href="<?php echo U('Index/Index');?>" class="China">
              <?php echo (L("head_index")); ?>
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="dropdown ">
            <a class="dropdown-toggle China hidden-xs" data-toggle="dropdown" href="Case.html"><?php echo (L("title_Product")); ?></a>
          ...
          <li <?php if($style_change == Vocationlist): ?>class="active"<?php endif; ?>>
            <a class="China" href="<?php echo U('Vocationlist/Index');?>"><?php echo (L("head_Industry")); ?></a>
          </li>
          <li <?php if($style_change == Codeinput): ?>class="active"<?php endif; ?>>
            <a class="China" href="<?php echo U('Codeinput/Index');?>"><?php echo (L("head_support")); ?></a>
          </li>
          <li <?php if($style_change == Aboutus): ?>class="active"<?php endif; ?>>
            <a class="China" href="<?php echo U('Aboutus/Index');?>"><?php echo (L("head_about")); ?></a>
          </li>
		...
		<ul class="nav navbar-nav navbar-right top-nav" style="width: 300px;">
							...
							<li class="search_c hidden-sm hidden-xs">
								<a href="#"><?php echo (L("head_search")); ?> <i class="glyphicon glyphicon-search"></i></a>
							</li>
  ...
  <!--/ 导航-->
				...
				<div class=" news_content">
			        <div class="col-sx-12 classification container">
			            <?php if(is_array($hztype_arr)): $i = 0; $__LIST__ = $hztype_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-xs-12">
			                <span> <?php echo ($vo['hz']['hzname']); ?> <i class="icon iconfont icon-jiantou"></i></span>
				...
				<div class="news">
					...
					<div class="container">
						<div class="row news-content">
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								...
								<div class="col-md-12">
								 ...
								 <?php if(is_array($felgptdowns)): $i = 0; $__LIST__ = $felgptdowns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-12" style="margin:10px 0;">
											  ...
											  <a href="/new/Public/Uploads/<?php echo ($vo['down']); ?>" target="view_window" style="display: inline-block;width:100%;word-break: break-all; "><button style="display: inline-block;width:100%;" type="button" class="downloadbutton"><?php echo ($vo['downname']); ?><i class="icon iconfont icon-xiazai"></i></button></a>
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="thumbnail">
										<img src="/new<?php echo ($felgxiangqing["ftimg"]); ?>" alt="" style="border:none;" >
								</div>
							</div>
		...
		<script type="text/javascript" src="/new/Public/qiantai/search_demo/jquery.min.js"></script>
		<script type="text/javascript" src="/new/Public/qiantai/js/bootstrap.js"></script>
		<script type="text/javascript" src="/new/Public/qiantai/js/nav.js"></script>
		<!-- ios下头部固定方案防止头部随着页面上拉滚动 -->
		<script type="text/javascript" src="/new/Public/qiantai/iostopfixed/scrollfix.js"></script>
		<!-- 搜索预览插件 -->
		<script type="text/javascript" src="/new/Public/qiantai/search_demo/aircity.js"></script>
		<script src="js/main.js"></script>
		<script src="layer/mobile/layer.js"></script>
		<script type="text/javascript" src="/new/Public/qiantai/js/connectUs.js"></script>
