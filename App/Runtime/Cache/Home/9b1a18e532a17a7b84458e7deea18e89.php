...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/new/Public/qiantai/swiper/swiper.min.css">
		<style type="text/css">
		...
		<main class="max-width-index">
	     ...
	     <div class="details container" style="margin:auto;margin-left:0;margin-right:0;padding:0;">
					...
					<?php if(is_array($hztypes_arr)): $j = 0; $__LIST__ = $hztypes_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($j % 2 );++$j;?><div class="panel panel-default">
							...
							<div id="<?php echo (str_replace(' ','',$vo['type']['fgtypename'])); ?>" class="panel-collapse collapse <?php if($j == 1): ?>in<?php else: endif; ?>">
												...
												<div class="swiper-wrapper">
													...
													<?php if(is_array($vo['pt'])): $i = 0; $__LIST__ = $vo['pt'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
																<div class="product-img">
																	<a target="_top" href="<?php echo U('Productdetails/index');?>?type=1&&id=<?php echo ($pt['id']); ?>"><img src="/new<?php echo ($pt['ftimg']); ?>" alt="product"/></a>
																</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								...
								<div>
									<form class="">
										...
										<button type="button" class="font-index-btn matter-button">提交</button>
							...
							<div class="col-lg-6 qr-code" >
								...
								<div>
									 <img src="/new/Public/qiantai/img/qr-code.png" >
								</div>
								<div>
...
<script type="text/javascript" src="/new/Public/qiantai/js/jquery.js"></script>
		...
		<script type="text/javascript" src="/new/Public/qiantai/swiper/swiper.min.js"></script>
		...
		<script src="/new/Public/qiantai/js/main.js"></script>
		<script src="/new/Public/qiantai/layer/mobile/layer.js"></script>
