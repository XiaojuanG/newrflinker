				...
				<div class=" news_content">
			        <div class="col-sx-12 classification container">
						 ...
						 <?php if(is_array($hztype_arr)): $i = 0; $__LIST__ = $hztype_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-xs-12">
									<span> <?php echo ($vo['hz']['rflinkerhz']); ?> <i class=" icon iconfont icon-jiantou"></i></span>
									<ul class="list-unstyled ">
										<?php if(is_array($vo['type'])): $i = 0; $__LIST__ = $vo['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voer): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Rflinkerhztype/index');?>?typeid=2&fid=<?php echo ($voer['hzid']); ?>" id="<?php echo ($voer['id']); ?>"><?php echo ($voer['fgtypename']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
													...
													<?php if(is_array($vo['pt'])): $i = 0; $__LIST__ = $vo['pt'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
															<a href="projectDeta.html">
																<div class="product-img">
																	<a target="_top" href="<?php echo U('Productdetails/index');?>?type=2&&id=<?php echo ($pt['id']); ?>"><img src="/rflinker<?php echo ($pt['ftimg']); ?>" alt="product"/></a>
																</div>
															</a>
															<a href="projectDeta.html">
																<div class="product-text">
																	<a target="_top" href="<?php echo U('Productdetails/index');?>?type=2&&id=<?php echo ($pt['id']); ?>"><span><?php echo ($pt['ftname']); ?><i class="icon iconfont icon-fanhuiyou""></i></span></a>
