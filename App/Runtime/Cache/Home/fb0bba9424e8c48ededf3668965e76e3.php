...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/newrflinker/Public/qiantai/css/commonDownload.css">
				...
				<div id="carousel-example-generic" class="carousel slide banner" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="/newrflinker/Public/qiantai/img/banner1.jpg" alt="">
    ...
    margin-top: 50px;">
							...
							<div class="col-xs-12">
								...
								<?php if(is_array($supports)): $i = 0; $__LIST__ = $supports;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><a href="/newrflinker/Public/Uploads/<?php echo ($val['file']); ?>" target="view_window"><li class="col-md-4 col-xs-12"><?php echo ($val['stname']); ?><i class="iconfont">&#xe615;</i></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
								</ul>
							</div>
        	...
        	$('.vipbutton').on('click', function() {
			  ...
			  $codelink = "<?php echo U('Codeinfo/Index');?>";
	            ...
	            var code = requestData.vipname;
				     $.ajax({
							type:"POST",
							url:"/newrflinker/index.php/Home/Codeinput/code",
							dataType: "json",
							data:{"code":code},
							success: function(data){
                                 if(data == 1){
