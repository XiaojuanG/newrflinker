								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea name="cn_title" cols="70" rows="5"><?php echo ($link['cn_title']); ?></textarea>
												<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
											</div>
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea name="en_title" cols="70" rows="5"><?php echo ($link['en_title']); ?></textarea>
												<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
											</div>
...
<script type="text/javascript" src="/new/Public/ckeditor/ckeditor.js"></script>
				<!-- basic scripts -->
